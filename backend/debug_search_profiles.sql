-- TEMPORARY: Simplified search_profiles for debugging
-- This version doesn't exclude the current user to help debug
CREATE OR REPLACE FUNCTION search_profiles_debug(
  search_query TEXT,
...
BEGIN
  ...
  WHERE 
    -- REMOVED: p.id != current_user_id (for debugging)
    (

...
-- 2. Insert "ElevateHire" as a Trusted Provider (if not exists)
...
SELECT 'ElevateHire', 'ELEVATEHIRE', 'https://elevatehire.com', 'api', 100, 'A', true
WHERE NOT EXISTS (SELECT 1 FROM certification_providers WHERE short_code = 'ELEVATEHIRE');
